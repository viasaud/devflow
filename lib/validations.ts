...
export const QuestionSchema = z.object({
  ...
  description: z.string().min(50, "Description is too short").max(3000, "Description is too long"),
  tags: z
...
export const AnswerSchema = z.object({
  answer: z.string().min(50, "Answer is too short").max(3000, "Answer is too long"),
});
